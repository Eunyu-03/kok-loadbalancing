...
<img width="587" height="455" alt="Image" src="https://github.com/user-attachments/assets/a2430d05-ae9c-4343-a878-aafb4e623ffd" />

데이터 출처: KOSIS

최근 청년층(15~29세)의 고용 통계를 살펴보면, 남녀 모두 고용 인원이 지속적으로 감소하는 추세를 보이고 있다. 특히 2025년 5월부터 10월까지의 데이터를 보면:

- 👨‍💼 남성 청년 고용 인원은 약 1750명에서 1700명 이하로 감소
- 👩‍💼 여성 청년 고용 인원은 1900명 이상에서 1850명 수준으로 하락

이러한 감소와 함께 ‘쉬었음’으로 분류되는 청년층의 비경제활동 인구가 증가하고 있다. 이는 단순한 구직 실패를 넘어 구직 기회 자체의 부족을 시사한다.

그 원인 중 하나로 많은 기업들이 **경력직을 선호**하는 채용 관행이 지목되고 있다. 이는 경력을 쉽게 쌓을 수 없는 청년 구직자들에게 큰 장벽으로 작용하고 있으며, 동시에 기업 입장에서도 **재직자의 휴가나 출장 등으로 발생하는 공석을 효율적으로 메우기 어려운 문제**를 안고 있다.

이에 따라, 점점 줄어드는 취업자와 늘어나는 ‘쉬었음’ 청년의 구직 실패 사유를 고려하여 **재직자가 자리를 비우는 기간에 직무를 체험해 볼 수 있는 서비스**의 필요성이 제기되었다. 이 서비스는 구직자에게 실질적인 경력의 단초를 제공하고, 기업에게는 공백을 메우는 동시에 예비 인재를 검증할 수 있는 기회를 제공한다.

또한, 체험에 합격하여 직업을 체험해 본 구직자만 인턴 공고에 지원할 수 있도록 하여 구직자의 실무 역량을 기반으로 한 선별이 가능하다.

구직자들끼리 취업 정보 등을 나눌 수 있는 **커뮤니티 기능**도 함께 기획되었다.
