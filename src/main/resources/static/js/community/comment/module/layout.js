                ...
                comment.replies.forEach(reply => {
                    text += `
                        <div class="post-13 reply-item" style="padding:8px; border-bottom:none; gap:5px;" data-reply-id="${reply.id}">
                            ...
                            <div class="reply-14" style="display:none;">
                                <div class="reply-15">
                                    <div class="reply-16">
                                        <div class="reply-17">
                                            <textarea maxlength="2000" rows="1" class="reply-18 reply-edit-text">${reply.replyContent}</textarea>
                                            <p class="reply-update-submit" data-reply-id="${reply.id}" style="cursor:pointer; color:#0066ff; font-weight:500;">수정</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="reply-mobile" style="display:none;">
                                <div class="reply-15">
                                    <div class="reply-16">
                                        <div class="reply-17">
                                            <textarea maxlength="2000" rows="1" class="reply-18 reply-edit-text">${reply.replyContent}</textarea>
                                            <svg class="reply-update-submit-mobile" data-reply-id="${reply.id}" fill="currentColor" height="24" width="24" style="cursor:pointer; color:#0066ff;">
